...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, \
    EmptyForm, PostForm, ResetPasswordRequestForm, ResetPasswordForm # type: ignore
from app.models import User, Post
from app.email import send_password_reset_email # type: ignore
...
def reset_password(token):
    if current_user.is_authenticated:
        return redirect(url_for('index'))
    user = User.verify_reset_password_token(token) # type: ignore
    if not user:
        return redirect(url_for('index'))
